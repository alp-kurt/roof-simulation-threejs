        ...
        <div className="App-grid">
          <section className="Controls-panel">
            ...
            <div className="Control-row">
              <label htmlFor="preset">Span Presets</label>
              <select
                id="preset"
                value=""
                onChange={(e) => {
            ...
            <div className="Control-row">
              <label htmlFor="width">Truss Width (m)</label>
              <input 
                id="width"
                type="number" 
                value={trussWidth} 
            ...
            <div className="Control-row">
              <label htmlFor="spacing">Max Vertical Spacing (m)</label>
              <input 
                id="spacing"
                type="number" 
            ...
            <div className="Control-row">
              <label htmlFor="memberSize">Member Size (m)</label>
              <input 
                id="memberSize"
                type="number" 
                value={memberSize} 
